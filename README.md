...
[Module 12](t81_558_class_12_01_ai_gym.ipynb)<br>**Meet on 11/18/2019** | <ul><li>Kaggle Assignment due: 11/17/2019 (approx 4-6PM, due to Kaggle GMT timezone)<li>**We will meet on campus this week!** (4th Meeting)<li>Part 12.1: Introduction to the OpenAI Gym<li>Part 12.2: Introduction to Q-Learning for Keras<li>Part 12.3: Keras Q-Learning in the OpenAI Gym<li>Part 12.4: Atari Games with Keras Neural Networks<li>Part 12.5: How Alpha Zero used Reinforcement Learning to Master Chess</ul>
